...
from app.agent_runtime_app import AgentRuntimeApp
...
@pytest.fixture
def agent_app(monkeypatch: pytest.MonkeyPatch) -> AgentRuntimeApp:
    """Fixture to create and set up AgentRuntimeApp instance"""
...
@pytest.mark.asyncio
async def test_agent_on_message_send(agent_app: AgentRuntimeApp) -> None:
...
@pytest.mark.asyncio
async def test_agent_card(agent_app: AgentRuntimeApp) -> None:
